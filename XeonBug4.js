...
//time
const xtime = moment.tz('Cameroon/Douala').format('HH:mm:ss')
        const xdate = moment.tz('Cameroon/Douala').format('DD/MM/YYYY')
...
"callType": "2",
"scheduledTimestampMs": `${moment(1000).tz("Cameroon/Douala").format("DD/MM/YYYY HH:mm:ss")}`,
"title": xeonybug1,
}
